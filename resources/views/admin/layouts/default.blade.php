...
<html lang="en">
	...
	<head>
		...
		<meta charset="utf-8" />
		<meta name="description" content="TZtech Admin - Developped by Ztech Developer Team" />
		<meta name="keywords" content="Ztech Admin - Developped by Ztech Developer Team" />
		<meta name="viewport" content="width=device-width, initial-scale=1" />
		<meta property="og:locale" content="en_US" />
		<meta property="og:type" content="article" />
		<meta property="og:title" content="Ztech Admin - Developped by Ztech Developer Team" />
		<meta property="og:url" content="https://ztech.com.vn" />
		<meta property="og:site_name" content="Ztech Admin by Ztech" />
		<link rel="canonical" href="http://index.html" />
		<link rel="shortcut icon" href="<?php echo url("admin"); ?>/assets/media/logos/favicon.ico" />
		<!--begin::Fonts(mandatory for all pages)-->
		<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Inter:300,400,500,600,700" />
		<!--end::Fonts-->
		<!--begin::Vendor Stylesheets(used for this page only)-->
		<link href="<?php echo url("admin"); ?>/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css" rel="stylesheet" type="text/css" />
		<link href="<?php echo url("admin"); ?>/assets/plugins/custom/datatables/datatables.bundle.css" rel="stylesheet" type="text/css" />
		<!--end::Vendor Stylesheets-->
		<!--begin::Global Stylesheets Bundle(mandatory for all pages)-->
		<link href="<?php echo url("admin"); ?>/assets/plugins/global/plugins.bundle.css" rel="stylesheet" type="text/css" />
		<link href="<?php echo url("admin"); ?>/assets/css/style.bundle.css" rel="stylesheet" type="text/css" />
		...
		<script src="<?php echo url("admin"); ?>/assets/plugins/global/plugins.bundle.js"></script>
		<script src="<?php echo url("admin"); ?>/assets/js/scripts.bundle.js"></script>
		<!--end::Global Javascript Bundle-->
		<!--begin::Vendors Javascript(used for this page only)-->
		<script src="<?php echo url("admin"); ?>/assets/plugins/custom/fullcalendar/fullcalendar.bundle.js"></script>
		...
		<script src="<?php echo url("admin"); ?>/assets/plugins/custom/datatables/datatables.bundle.js"></script>
		<script src="<?php echo url("admin"); ?>/assets/plugins/custom/formrepeater/formrepeater.bundle.js"></script>
		<!--end::Vendors Javascript-->
		<!--begin::Custom Javascript(used for this page only)-->
		<script src="<?php echo url("admin"); ?>/assets/js/custom/apps/ecommerce/catalog/save-product.js"></script>
		<script src="<?php echo url("admin"); ?>/assets/js/custom/apps/ecommerce/catalog/edit-product.js"></script>
		<script src="<?php echo url("admin"); ?>/assets/js/widgets.bundle.js"></script>
		<script src="<?php echo url("admin"); ?>/assets/js/custom/widgets.js"></script>
		<script src="<?php echo url("admin"); ?>/assets/js/custom/apps/chat/chat.js"></script>
		<script src="<?php echo url("admin"); ?>/assets/js/custom/utilities/modals/upgrade-plan.js"></script>
		<script src="<?php echo url("admin"); ?>/assets/js/custom/utilities/modals/create-app.js"></script>
		<script src="<?php echo url("admin"); ?>/assets/js/custom/utilities/modals/new-target.js"></script>
		<script src="<?php echo url("admin"); ?>/assets/js/custom/utilities/modals/users-search.js"></script>
		<!--end::Custom Javascript-->
		<!--CKEditor Build Bundles:: Only include the relevant bundles accordingly-->
		<!--<script src="<?php echo url("admin"); ?>/assets/plugins/custom/ckeditor/ckeditor-classic.bundle.js"></script>-->
	...
	<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
				...
				<div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
					...
					<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="225px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
						...
						<div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
							<!--begin::Logo image-->
							<a href="index.html">
								<img alt="Logo" src="<?php echo url("admin"); ?>/assets/media/logos/ztech-logo.png" class="h-25px app-sidebar-logo-default" />
								<img alt="Logo" src="<?php echo url("admin"); ?>/assets/media/logos/ztech-logo.png" class="h-20px app-sidebar-logo-minimize" />
							</a>
							<!--end::Logo image-->
        ...
        -->
						...
						<div class="app-sidebar-footer flex-column-auto pt-2 pb-6 px-6" id="kt_app_sidebar_footer">
							<a href="https://ztech.com.vn" target="_blank" class="btn btn-flex flex-center btn-custom btn-primary overflow-hidden text-nowrap px-0 h-40px w-100" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss-="click" title="200+ in-house components and 3rd-party plugins">
								<span class="btn-label">Ztech DevTeam</span>
