...
@section('title', 'Tạo danh mục bài viết | Ztech Admin')
...
@section('content_wrapper')
						...
						<div class="d-flex flex-column flex-column-fluid">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										...
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
											...
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item text-muted"><?php echo __('admin/homepage.post_category_create'); ?></li>
											<!--end::Item-->
										</ul>
										<!--end::Breadcrumb-->
									</div>
							...
							<div id="kt_app_content" class="app-content flex-column-fluid">
								...
								<div id="kt_app_content_container" class="app-container container-xxl">
									<!--begin::Form-->
									<form id="kt_ecommerce_add_product_category_form" class="form d-flex flex-column flex-lg-row" data-kt-redirect="<?php echo route('post.saveCreateCategories'); ?>" method="post" action="<?php echo route('post.saveCreateCategories');?>" enctype="multipart/form-data">
										@csrf
									<!--begin::Aside column-->
										...
										<div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
												...
												<div class="tab-pane fade show active" id="kt_ecommerce_add_product_general" role="tab-panel">
													<div class="d-flex flex-column gap-7 gap-lg-10">
														...
														<div class="card card-flush py-4">
															...
															<div class="card-header">
																<div class="card-title">
																	<h2><?php echo __('admin\homepage.post_category_create'); ?></h2>
																</div>
															</div>
															<!--end::Card header-->
															<!--begin::Card body-->
															<div class="card-body pt-0">
																...
																<div class="mb-10 fv-row">
																	...
																	<!--end::Label-->
																	<!--begin::Input-->
																	<input type="text" name="title" class="form-control mb-2" placeholder="<?php echo __('admin/homepage.post_title'); ?>" value="" />
																	<!--end::Input-->
																	<!--begin::Description-->
																...
																<div class="mb-10 fv-row">
																	<!--begin::Label-->
																	<label class="form-label"><?php echo __('admin/homepage.post_description'); ?></label>
																	<!--end::Label-->
																	<!--begin::Input-->
																	<input type="text" name="description" class="form-control mb-2" placeholder="<?php echo __('admin/homepage.post_description'); ?>" value="" />
																	<!--end::Input-->
																...
																<div class="mb-10 fv-row">
																	<!--begin::Label-->
																	<label class="required form-label"><?php echo __('admin/homepage.post_category_parent'); ?></label>
																	<!--end::Label-->
																																
                                                                    <!--begin::Select2-->
																	<select class="form-select mb-2" data-control="select2" data-hide-search="true" data-placeholder="Select an option" id="kt_ecommerce_add_post_status_select" name="parent_category">
														...
														<div class="card card-flush py-4">
															...
															<div class="card-body pt-0">
																...
																<div class="mb-10">
																	...
																	<!--end::Label-->
																	<!--begin::Editor-->
																	<input type="text" class="form-control mb-2" name="meta_description" placeholder="Meta tag description" />
																	<!--end::Editor-->
																	<!--begin::Description-->
																...
																<div>
																	...
																	<!--end::Label-->
																	<!--begin::Editor-->
																	<input id="kt_ecommerce_add_post_meta_keywords" name="meta_keywords" class="form-control mb-2" placeholder="Meta tag keyword"/>
																	<!--end::Editor-->
																	<!--begin::Description-->
											...
											<div class="d-flex justify-content-end">
												<!--begin::Button-->
												<a href="<?php echo route('post.list'); ?>" id="kt_ecommerce_add_product_cancel" class="btn btn-light me-5">Cancel</a>
												<!--end::Button-->
												<!--begin::Button-->
					...
					<script>
						ClassicEditor
						.create(document.querySelector('#kt_ecommerce_add_product_content'))
						.then(editor => {
							console.log(editor);
						})
						.catch(error => {
