...
@section('title', 'Tạo bài viết | Ztech Admin')
						...
						<div class="d-flex flex-column flex-column-fluid">
							...
							<div id="kt_app_content" class="app-content flex-column-fluid">
								...
								<div id="kt_app_content_container" class="app-container container-xxl">
									<!--begin::Form-->
									<form id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row" data-kt-redirect="<?php echo route('post.savecreate'); ?>" method="post" action="<?php echo route('post.savecreate');?>" enctype="multipart/form-data">
										@csrf
									<!--begin::Aside column-->
															...
															<div class="card-body pt-0">
																...
																<div>
																	...
																	<div class="py-5" data-bs-theme="light">
																		<textarea name="content" id="kt_ecommerce_add_product_content">																			
