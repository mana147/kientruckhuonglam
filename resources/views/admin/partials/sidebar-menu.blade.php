									...
									<div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
										...
										<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
											...
											<span class="menu-link">
												...
												<span class="menu-title"><?php echo __('admin/homepage.dashboard'); ?></span>
										...
										<div class="menu-item pt-5">
											...
											<div class="menu-content">
												<span class="menu-heading fw-bold text-uppercase fs-7"><?php echo __('admin/homepage.content'); ?></span>
											</div>
											<!--end:Menu content-->
										</div>
										<!--end:Menu item-->
										...
										<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
											...
											<span class="menu-link">
												...
												<span class="menu-title"><?php echo __('admin/homepage.post'); ?></span>
												<span class="menu-arrow"></span>
											</span>
											<!--end:Menu link-->
											<!--begin:Menu sub-->
											<div class="menu-sub menu-sub-accordion menu-active-bg">
												<!--begin:Menu item **************** QUẢN LÝ BÀI VIẾT *****************-->
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link" href="<?php echo route('post.create'); ?>">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
														<span class="menu-title"><?php echo __('admin/homepage.post_add'); ?></span>
													</a>
													<!--end:Menu link-->
												</div>
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link" href="<?php echo route('post.list'); ?>">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
														<span class="menu-title"><?php echo __('admin/homepage.post'); ?></span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link" href="<?php echo route('post.categories'); ?>">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
														<span class="menu-title"><?php echo __('admin/homepage.post_category'); ?></span>
													</a>
													<!--end:Menu link-->
												</div>
												<!--end:Menu item-->
