...
var KTAppEcommerceSaveProduct =  function () {
     const e =  () =>  {
         $("#kt_ecommerce_edit_product_options").repeater({
             initEmpty:  ! 1,
             defaultValues:  {
                 "text-input":  "foo"
            },
     ...
     t =  () =>  {
     t =  () =>  {
         document.querySelectorAll('[data-kt-ecommerce-catalog-edit-product="product_option"]').forEach((e =>  {
    ...
    return {
         init:  function () {
            var o,  a;
            ["#kt_ecommerce_edit_product_description",  "#kt_ecommerce_edit_product_meta_description"].forEach((e =>  {
             ...
             ["#kt_ecommerce_edit_product_category",  "#kt_ecommerce_edit_product_tags"].forEach((e =>  {
             ...
             o =  document.querySelector("#kt_ecommerce_edit_product_discount_slider"),
             a =  document.querySelector("#kt_ecommerce_edit_product_discount_label"),
             noUiSlider.create(o,  {
                 start:  [10],
                 connect:  ! 0,
                 range:  {
             ...
             e(),
             new Dropzone("#kt_ecommerce_edit_product_media",  {
             ...
             t(),
             (() =>  {
                 const e =  document.getElementById("kt_ecommerce_edit_product_status"),
                 t =  document.getElementById("kt_ecommerce_edit_product_status_select"),
                 ...
                 const a =  document.getElementById("kt_ecommerce_edit_product_status_datepicker");
                 $("#kt_ecommerce_edit_product_status_datepicker").flatpickr({
                     enableTime:  ! 0,
             ...
             (() =>  {
                 ...
                 t =  document.querySelector('[data-kt-ecommerce-catalog-edit-category="auto-options"]');
                 e.forEach((e =>  {
             ...
             (() =>  {
                 ...
                 t =  document.getElementById("kt_ecommerce_edit_product_discount_percentage"),
                 o =  document.getElementById("kt_ecommerce_edit_product_discount_fixed");
                 e.forEach((e =>  {
                     e.addEventListener("change",  (e =>  {
             ...
             (() =>  {
                 const e =  document.getElementById("kt_ecommerce_edit_product_shipping_checkbox"),
                 t =  document.getElementById("kt_ecommerce_edit_product_shipping");
                 e.addEventListener("change",  (e =>  {
